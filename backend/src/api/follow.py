...
@api.post("/{follower_id}/follow/{followed_id}",
          response_model=HttpResponseModel)
...
@api.post("/{follower_id}/unfollow/{followed_id}",
          response_model=HttpResponseModel)
...
@api.post("/{requester_id}/accept_request/{requested_id}",
          response_model=HttpResponseModel)
...
@api.post("/{requester_id}/reject_request/{requested_id}",
          response_model=HttpResponseModel)
...
@api.get("/{user_id}/follow_requests_as_requester",
         response_model=HttpResponseModel)
...
@api.get("/{user_id}/follow_requests_as_requested",
         response_model=HttpResponseModel)
