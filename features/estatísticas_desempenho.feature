...
As a usuário eu quero poder ter acesso aos meus comentários 
em um dashboard ao longo do tempo(ano, mês, semana) e a média de comentários
nesses mesmos intervalos de tempo, para que eu possa ter uma visão geral do meu desempenho.
...
# Requisição bem-sucedida para obter dados do gráfico ( serviço )
...
When o sistema recebe uma requisição GET "/{João Henrique}/dashboard?period=last30days&metric=followers"
